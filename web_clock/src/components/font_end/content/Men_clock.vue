...
<div >
    ...
    <div v-if="User!=false&&Loading == false" class="wrapped">
        ...
        <div class="title-allproduct">
            <div class="title"><p>ĐỒNG HỒ NAM</p></div>
            <div class="sort">
...
export default {
    ...
    watch:{
        ...
        Sort(){
            if(this.Sort == 1){
                this.Loading = true
                this.LinkProduct='/menproduct?page='
                this.getproduct()
            }
            if(this.Sort == 2){
                this.Loading = true
                this.LinkProduct='/menproductincrease?page='
                this.getproduct()                   
            }
            if(this.Sort == 3){
                this.Loading = true
                this.LinkProduct='/menproductdiscount?page='
                this.getproduct()
            }
            if(this.Sort == 4){
                this.Loading = true
                this.LinkProduct='/menproductold?page='
                this.getproduct()
            }
        }
    }

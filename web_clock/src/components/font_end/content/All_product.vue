...
<div >
    ...
    <div v-if="User!=false&&Loading == false" class="wrapped">
        ...
        <div class="title-allproduct">
            <div class="title"><p>TẤT CẢ SẢN PHẨM</p>
            </div>
            <div class="sort">
...
export default {
    ...
    watch:{
        ...
        Sort(){
            if(this.Sort == 1){
                this.Loading = true
                this.LinkProduct='/product?page='
                this.getproduct()
            }
            if(this.Sort == 2){
                this.Loading = true
                this.LinkProduct='/productincrease?page='
                this.getproduct()                   
            }
            if(this.Sort == 3){
                this.Loading = true
                this.LinkProduct='/productdiscount?page='
                this.getproduct()
            }
            if(this.Sort == 4){
                this.Loading = true
                this.LinkProduct='/productold?page='
                this.getproduct()
            }
        }
    }
